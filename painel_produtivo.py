...
# =========================
total_dia = float(base_48["QTD"].sum() + base_60L["QTD"].sum())
horas_exibidas = len([h for h in HORAS_TURNO if h != H_ALMOCO])
meta_turno_total = float((META_48 + META_60L) * horas_exibidas)
...
meta_acum_total = float((META_48 + META_60L) * len(hn))
...
# =========================
if modo_mobile:
    render_panel("60L — FORNOS DE BANCADA", base_60L, META_60L)
    render_panel("48 — 48 (48)", base_48, META_48)
else:
